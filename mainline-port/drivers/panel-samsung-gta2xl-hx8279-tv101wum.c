...
{
	return container_of_const(panel, struct hx8279_tv101wum_wuxga, panel);
}
...
static int hx8279_tv101wum_wuxga_on(struct hx8279_tv101wum_wuxga *ctx)
{
	...
	/* Send the init sequence in low-power mode, like the working
	 * boe-tv101wum-ll2 driver; switch back to HS for video below. */
